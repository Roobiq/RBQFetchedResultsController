...
/**
 *  Convenience method to add an object to the Realm and notify RBQRealmNotificationManager
 *
...
/**
 *  Convenience method to add a collection of RLMObjects to the Realm and notify RBQRealmNotificationManager
 *
...
/**
 *  Convenience method to add or update a RLMObject to the Realm and notify RBQRealmNotificationManager
...
/**
 *  Convenience method to add or update a collection of RLMObjects to the Realm and notify RBQRealmNotificationManager
...
/**
 *  Convenience method to delete a RLMObject from the Realm and notify RBQRealmNotificationManager
 *
...
/**
 *  Convenience method to delete a collection of RLMObjects from the Realm and notify RBQRealmNotificationManager
 *
 *  @param array A collection object that conforms to NSFastEnumeration (e.g. NSArray, RLMArray, RLMResults)
 */
